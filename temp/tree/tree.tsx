...
import { addLevel, addNodeCheckedProp, addNodeLeafParentProp, flatTree } from './process-tree-data';
import makeClassByPrefix from '../common/utils/makeClassByPrefix';
import { checkEffectHandle, makeNewCheckedKeys, unCheckEffectHandle } from './utils/tree-check';
...
const Tree: FC<Props> = ({ treeData, children, expandKeys, ...rest }) => {
  const [treeNodes, setTreeNodes] = useState<TreeNode[]>(treeData),
    ...
    [expandKeysValue, setExpandKeysValue] = useState<string[]>(expandKeys || []),
